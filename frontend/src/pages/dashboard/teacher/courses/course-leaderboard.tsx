...
import { useLeaderboard } from '@/hook/class/use-get-course-leaderboard';
        ...
        <CardContent className='pt-6'>
          <div className='text-center space-y-3 py-12'>
            ...
            <p className='text-sm text-muted-foreground max-w-md mx-auto'>
              You don't have any courses yet. Create a course to view leaderboard.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className='bg-background border-0 shadow-none'>
        <CardHeader>
          <div className=' flex gap-3 justify-between'>
            <div>
              <CardTitle className='flex items-center gap-2 text-2xl'>Course Leaderboard</CardTitle>
              <CardDescription>View top performing students in your courses</CardDescription>
            </div>
